...
import com.fyp.sporteaze.Admin.AdminCreateAcademy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_upload_coach_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dexter.withActivity(AddCoach.this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE)
        ...
        btn_add_coach.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(et_coach_name.getText().toString().matches("") || et_coach_address.getText().toString().matches("")|| et_coach_charges.getText().toString().matches("")|| et_coach_phone.getText().toString().matches("")|| et_coach_age.getText().toString().matches("")|| et_coach_expertise.getText().toString().matches("")|| filepath == null)
                {
...
//                }
    ...
    private void upload_to_firebase(){
        ...
        dialog.setTitle("Registering Coach, please wait");
        dialog.show();
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            uploader.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Coach obj = new Coach(academy_id,uri.toString(), et_coach_name.getText().toString(), et_coach_address.getText().toString(), et_coach_age.getText().toString(), et_coach_expertise.getText().toString(), et_coach_phone.getText().toString(), et_coach_charges.getText().toString() , key);
                                    root.child("coaches").child(key).setValue(obj);
