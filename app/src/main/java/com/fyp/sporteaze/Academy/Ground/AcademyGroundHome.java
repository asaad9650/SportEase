...
public class AcademyGroundHome extends AppCompatActivity {

    ConstraintLayout add_ground_box, view_ground_box;
    String academy_email , academy_id, academy_name;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_academy_ground_home);
        add_ground_box = findViewById(R.id.add_ground_box);

        view_ground_box = findViewById(R.id.view_ground_box);
        ...
        add_ground_box.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent inte = new Intent(AcademyGroundHome.this , AcademyAddGround.class);
        ...
        view_ground_box.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent inte  = new Intent(AcademyGroundHome.this , AcademyViewGround.class);
                inte.putExtra("academy_email", academy_email);
                inte.putExtra("academy_id",academy_id);
                inte.putExtra("academy_name", academy_name);
                startActivity(inte);
...
//                    Toast.makeText(getApplicationContext() , item.getTitle().toString() , Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(AcademyGroundHome.this, AcademyHome.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    return true;
                ...
                else if (item.getTitle().equals("User registration request"))
                {
                    ...
                    Intent intent = new Intent(AcademyGroundHome.this, AcademyRentRequest.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    return true;
                ...
                else if (item.getTitle().equals("Team registration request"))
                {
                    ...
                    Intent intent = new Intent(AcademyGroundHome.this, AcademyTeamRentRequest.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    return true;
                    ...
                    Intent intent = new Intent(AcademyGroundHome.this , LoginActivity.class);
                    startActivity(intent);
                    finish();
                }
