...
public class AcademyTeamRentRequest extends AppCompatActivity {
    List<Academy_registration_team> academy_registration_teamList;
    RecyclerView academy_team_rent_request_recycler_view;
    AcademyTeamRentAdapter academyTeamRentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_academy_team_rent_request);

        academy_team_rent_request_recycler_view = findViewById(R.id.academy_team_rent_request_recycler_view);

        text_no_academy_request = findViewById(R.id.text_no_academy_request);
        academy_team_rent_request_recycler_view.setLayoutManager(new LinearLayoutManager(this));
        academy_registration_teamList = new ArrayList<>();
        academy_team_rent_request_recycler_view.setVisibility(View.GONE);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("academy_team_bookings");
        ...
        databaseReference.orderByChild("academy_id").equalTo(academy_id).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot2) {
                ...
                for (DataSnapshot dataSnapshot : snapshot2.getChildren()) {
                    Academy_registration_team us = dataSnapshot.getValue(Academy_registration_team.class);

                    if(us.getRequest_status().matches("pending")) {
                        academy_registration_teamList.add(us);
                        academy_team_rent_request_recycler_view.setVisibility(View.VISIBLE);
                        text_no_academy_request.setVisibility(View.GONE);
                        academyTeamRentAdapter = new AcademyTeamRentAdapter(academy_registration_teamList, academy_id);
                        academy_team_rent_request_recycler_view.setAdapter(academyTeamRentAdapter);
                        Toast.makeText(AcademyTeamRentRequest.this, us.getAcademy_name(), Toast.LENGTH_SHORT).show();
                        if (academy_registration_teamList.size() == 0) {
                            text_no_academy_request.setVisibility(View.VISIBLE);
                            academy_team_rent_request_recycler_view.setVisibility(View.GONE);
                        }
                    }
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if(item.getTitle().equals("Coaches"))
                {
                    ...
                    Intent intent = new Intent(AcademyTeamRentRequest.this , AcademyCoachHome.class);
...
//                    Toast.makeText(getApplicationContext() , item.getTitle().toString() , Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(AcademyTeamRentRequest.this , AcademyGroundHome.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    Toast.makeText(getApplicationContext() , item.getTitle().toString() , Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(AcademyTeamRentRequest.this, AcademyHome.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    startActivity(intent);
...
//                    return true;
                ...
                else if (item.getTitle().equals("User registration request"))
                {
                    ...
                    Intent intent = new Intent(AcademyTeamRentRequest.this, AcademyRentRequest.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    return true;
                    ...
                    Intent intent = new Intent(AcademyTeamRentRequest.this , LoginActivity.class);
                    startActivity(intent);
                    finish();
                }
