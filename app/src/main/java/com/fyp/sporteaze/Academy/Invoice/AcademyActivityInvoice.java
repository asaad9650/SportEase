...
public class AcademyActivityInvoice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_academy_invoice);
        ...
        view_coach_request_box.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AcademyActivityInvoice.this , AcademyGenerateInvoice.class);
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if(item.getTitle().equals("Coaches"))
                {
                    ...
                    Intent intent = new Intent(AcademyActivityInvoice.this , AcademyCoachHome.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    Toast.makeText(getApplicationContext() , item.getTitle().toString() , Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(AcademyActivityInvoice.this, AcademyHome.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    Toast.makeText(getApplicationContext() , item.getTitle().toString() , Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(AcademyActivityInvoice.this , AcademyGroundHome.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    return true;
                ...
                else if (item.getTitle().equals("User registration request"))
                {
                    ...
                    Intent intent = new Intent(AcademyActivityInvoice.this, AcademyRentRequest.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    return true;
                ...
                else if (item.getTitle().equals("Team registration request"))
                {
                    ...
                    Intent intent = new Intent(AcademyActivityInvoice.this, AcademyTeamRentRequest.class);
                    intent.putExtra("academy_email", academy_email);
                    intent.putExtra("academy_id",academy_id);
                    intent.putExtra("academy_name", academy_name);
                    startActivity(intent);
...
//                    return true;
                    ...
                    Intent intent = new Intent(AcademyActivityInvoice.this , LoginActivity.class);
                    startActivity(intent);
                    finish();
                }
