...
public class UpcomingMatchesAdapter extends RecyclerView.Adapter {
    ...
    int month, year, day;
    public UpcomingMatchesAdapter(List<CreateMatchBetweenTeams> createMatchBetweenTeamsList, String user_id, String user_name, String user_email, String user_phone, String user_dob, String user_address) {
