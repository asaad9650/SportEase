...
public class UserGroundAdapter extends RecyclerView.Adapter {
    ...
    public UserGroundAdapter(List<Ground> groundList, String user_id, String user_name, String user_email, String captain, String team_id) {
            ...
            viewHolderClass.btn_ground_view_details.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (captain.matches("yes")) {
                        Intent intent = new Intent(view.getContext(), TeamRentGround.class);
                        ...
                        intent.putExtra("academy_id" , grounds.getAcademy_id());
